<?php
    ...
    $detailPesananTableStructure = [["Nama Meja","Customer","Jumlah Orang","Tanggal Masuk","Status Pesanan",'action_name' => "Kembali","isMany" => false,"Action" => "../"],["nama_meja","customer","jumlah_orang","tanggal_masuk","status"]];
