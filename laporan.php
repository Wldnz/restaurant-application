<?php
    ...
    $laporanStructure = [
        ["ID","Nama Meja","Customer","Jumlah","Total Harga","Tanggal Masuk","Tanggal Keluar","action_name" => "Lihat Detail...","isMany" => true,"Action" => "$url/cashier/pesanan/detailPesanan.php"],
